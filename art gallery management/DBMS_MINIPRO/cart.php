        ...
        <div>
            ...
            <div class="container">
                <table class="table table-bordered table-striped">
                    <br><br>
                    <div class="fontcolor">
                    <h2 ><u>Paintings You Have Selected!</u><br><br>
                    </div>
                    <tbody>
                        <tr>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><a href="success.php" class="btn btn-primary">Confirm Order</a></th>
                        </tr>
                    </tbody>
                </table>
                <center><a href="products.php?id=<?php echo $user_id?>" class="btn btn-primary">Add More</a></th><br><br><br><br>
            </th>
            </div>
